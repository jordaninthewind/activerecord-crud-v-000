...
def can_be_created_in_a_block # This makes no sense with the tests as they are written.
...
def can_destroy_a_single_item
  ...
  x = Movie.find_by title: "That One Where the Guy Kicks Another Guy Once".id
  Movie.destory(x)
end
